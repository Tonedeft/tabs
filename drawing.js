...
function draw_tab_cursor(ctx, cursor, options) {
	options = options || {};
	// Draw 6 lines across the page
	...
	// Default variables that are not provided
	stroke = options.stroke || 'rgba(0,0,255,1)';
	fill = options.fill || 'rgba(255,255,0,0.2)'; // blue green
	...
	staffTop = staffSpacing + staffIndex * ((linesPerStaff) * lineSpacing + staffSpacing) - .5 * lineSpacing;
